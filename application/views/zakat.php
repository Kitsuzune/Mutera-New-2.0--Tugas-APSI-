...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#zakatsiuuuuuuu">Zakat</a>
                    </li>
                    <li class="nav-item">
    ...
    <!-- Basic -->
    <div class="ex-basic-1 pt-5 pb-5" id="zakatsiuuuuuuu">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <img src="<?= base_url('public/') ?>images/zakat.jpg" class="rounded image-fluid" alt="zakat" width="450px" height="450px">
                    </div>
                </div>
                <div class="mt-xl-4"><br>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <div class="row">
                                            <div class="text-center">
                                                <a class="btn-solid-lg" href="utama/mutera">Melalui Mutera</a><br>
                                            </div>
                    ...
                    <div class="mt-xl-4">
                        <br>
                        <div class="col-md-12">
                            <strong> QS. At Taubah: 103</strong> <br>
                            <br>
                            ...
                            <p>
                                “Ambil lah zakat dari harta mereka, guna membersih kan dan menyucikan mereka, dan berdoa lah untuk mereka. Sesungguhnya doamu itu (menumbuhkan) ketenteraman jiwa bagi mereka. Allah Maha Mendengar, Maha Mengetahui.”
                            </p>
                        </div>
                    </div> <!-- end of col -->
                </div>
