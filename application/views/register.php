                                ...
                                <div class="uk-card-body">
                                    ...
                                    <div class="uk-margin">
                                                <div class="uk-position-relative">
                                                    ...
                                                    <input name="namaLengkap" class="uk-input" required placeholder="Nama Lengkap" id="namaLengkap" type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="uk-margin">
                                               ...
                                               <div class="uk-margin">
                                                <div class="uk-position-relative">
                                                    <span class="uk-form-icon ion-locked"></span>
                                                    <input name="confirm_password" class="uk-input" type="password" required  id="confirm_password" placeholder="Confirm password">
                                                </div>
                                            </div>
                                            ...
                                            <div class="uk-margin">
                                                <button type="button" id="register" class="uk-button uk-button-primary">
                                                    <span class="ion-forward"></span>&nbsp; Register
                                                </button>
                                            </div>
                                            Sudah punya akun?
                                            <div class="uk-margin">
                                                <button type="button" class="uk-button uk-button-primary"  onclick="window.location.href='<?= base_url('login')?>'">
