                ...
                <nav uk-navbar>
                    ...
                    <div class="uk-navbar-right uk-light">
                        <ul class="uk-navbar-nav">
                            <li class="uk-active">
                                <a href="#"><?=$this->session->userdata('nama')?> &nbsp;<span class="ion-ios-arrow-down"></span></a>
        ...
        <div id="sidebar" class="tm-sidebar-left uk-background-default">
            <center>
                <div class="user">
                    ...
                    <div id="name" class="uk-text-truncate"><?=$this->session->userdata('nama')?></div>
            ...
            <ul class="uk-nav uk-nav-default">
                ...
                ><a href="<?=base_url('dashboard')?>"><span data-uk-icon="icon: home" class="uk-margin-small-right"></span>Beranda</a></li>
                ...
                <a href="<?=base_url('administrator/users')?>"><span data-uk-icon="icon: users" class="uk-margin-small-right"></span>Users</a></li>
					...
					?>
                     ...
                     <?php
						if ($this->session->userdata('status')=="admin" || $this->session->userdata('status')=="users") {
							?>
