...
class M_model extends CI_Model
{
     ...
     public function get_tampil_riwayat_user($limit, $offset, $search, $count, $namacari, $urut, $idUser)
     {
     ...
     public function count(){
          $this->db->select('*, count(riwayat.idLokasi) as banyak_riwayat, sum(riwayat.jumlah) as jumlah_riwayat, lokasi.idLokasi as idLokasi, lokasi.maximum as maximum');
          $this->db->from('lokasi');
          $this->db->join('riwayat','riwayat.idLokasi = lokasi.idLokasi','LEFT');
          $this->db->where('status', 'sudah bayar');
          $this->db->group_by('lokasi.idLokasi');
