...
class Riwayat extends CI_Controller
{
    ...
    public function tampil($offset = null)
	{
		...
		if($this->session->userdata('status')=="users"){
			$config['total_rows'] = $this->m_model->get_tampil_riwayat_user($limit, $offset, $search, $count = true, 'namaLengkap', 'idRiwayat',$this->session->userdata('idusers'));
		} else {
		...
		if($this->session->userdata('status')=="users"){
			$data['riwayat'] = $this->m_model->get_tampil_riwayat_user($limit, $offset, $search, $count = false, 'namaLengkap', 'idRiwayat',$this->session->userdata('idusers'));
		} else {
